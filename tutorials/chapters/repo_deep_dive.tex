...
The Rocket Chip is a general-purpose processor core that uses the RISC-V \gls{isa}.
It is a superset of the \nameref{sec:BOOM_Generator}, because it provides both an in-order execution core generator (Rocket), and the \nameref{sec:BOOM_Generator} for out-of-order execution.
