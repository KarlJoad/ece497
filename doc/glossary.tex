...
\newglossaryentry{spi}{
  ...
  first = {SPI~(Serial Peripheral Interface)\glsadd{isag}},
  see=[Glossary:]{spig}
}
...
\newglossaryentry{elaboration}{
  name = {Elaboration},
  description = {The actual build process of processor design generation.
    This involves finding all necessary submodules and ``gluing'' them together using the \texttt{TileLink} standard},
}

\newglossaryentry{elaborate}{
  type = \acronymtype,
  name = {Elaborate},
  description = {Process of converting parameterized RTL design to a set of gates and a simulation binary},
}
