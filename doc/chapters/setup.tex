...
Chipyard is a framework for designing, \glslink{elaborate}{elaborating}, simulating, testing, and building RISC-V CPU designs.
...
There are also tools for writing the elaborated designs out to \gls{fpga} bitstreams, so that simulation can be sped up and execution can occur on \glspl{softcore}.
...
% NOTE: The textcolor below should match the linkcolor in hypersetup in doc.tex!
