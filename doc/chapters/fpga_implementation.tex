...
\subsection{Compiling Programs}\label{sec:Compiling_Programs}
	...
	In the Freedom E SDK, default and custom projects are defined in the directory \file{/freedom-e-sdk/software/}. To compile a project for the Arty board, run the following command:
