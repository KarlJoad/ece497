...
To assist with the proper setup, we approached the \Gls{fpga} implementation of an \Gls{soc} by following the ``SiFive Freedom E310 Arty FPGA Dev Kit Getting Started Guide''~\cite{FreedomDevGuide}.
...
The configuration directory for the Arty \Gls{fpga} is located under \file{/src/main/scala/arty/}.
