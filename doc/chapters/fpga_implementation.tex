...
\subsection{Compiling Programs}\label{sec:Compiling_Programs}
	...
	In the Freedom E SDK, default and custom projects are defined in the directory \file{/freedom-e-sdk/software/}. To load a default or custom project onto the Arty board, use the following syntax:
