...
Harness binders in this file are provided for the JTAG interface, \Gls{spi} flash, and the \Gls{uart}  connector. These three connections are critical to the \Gls{fpga} design, and to ensuring that programs can be successfully uploaded and run on the \Gls{fpga}. 
...
In this file are custom configurations for the \Gls{spi} flash and JTAG connectors that will be utilized in the default design. 
